...
export const TacticalDeckModal: React.FC<TacticalDeckModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md font-sans">
      <div className="relative w-full max-w-5xl bg-[#090b10] border border-[#00f3ff55] shadow-[0_0_60px_rgba(0,243,255,0.25)] flex flex-col max-h-[90vh] overflow-hidden text-gray-200">
        
        {/* Top Header Bar */}
        <div className="flex items-center justify-between px-6 py-3.5 bg-[#0e131f] border-b border-[#00f3ff33]">
          <div className="flex items-center gap-3">
            <div className="p-1.5 bg-[#00f3ff22] border border-[#00f3ff] text-[#00f3ff]">
              <Cpu className="w-5 h-5 animate-pulse" />
            </div>
            <div>
              <h2 className="text-base sm:text-lg font-orbitron font-black text-white tracking-wider flex items-center gap-2">
                THIRTY3 <span className="text-[#00f3ff]">// CONSOLE TACTIQUE MULTI-DOCKER</span>
              </h2>
              <p className="text-[10px] font-mono text-[#00f3ff]/70 tracking-widest uppercase">
                Interconnexion Opérationnelle • 3 Outils Intégrés en Temps Réel
              </p>
            </div>
          </div>
        ...
        {/* Tab Navigation */}
        <div className="flex border-b border-[#00f3ff22] bg-[#0b0e14]">
          <button
            onClick={() => setActiveTab('world_monitor')}
            className={`flex-1 py-3 px-4 flex items-center justify-center gap-2 font-orbitron text-xs font-bold uppercase tracking-wider transition-all border-b-2 cursor-pointer ${
          ...
          >
            ...
            <span>2. ShadowBroker OSINT</span>
            <span className="text-[9px] font-mono px-1.5 py-0.2 bg-[#f59e0b22] text-[#f59e0b]">PORT 8001</span>
          </button>
          ...
          >
            ...
            <span>3. Deus Ex Sophia & STM</span>
            <span className="text-[9px] font-mono px-1.5 py-0.2 bg-[#ff00ff22] text-[#ff00ff]">PORT 8000</span>
          </button>
        </div>
